...
* `qr_creeator` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `QR Creeator` - executable or bundle name on disk.
* `QR Creeator` - display name shown in window titles and about app dialogs.
